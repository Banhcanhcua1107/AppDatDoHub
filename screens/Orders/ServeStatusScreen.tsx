...
const ServeItemRow: React.FC<{
  ...
  return (
    <View style={styles.itemContainer}>
      ...
      <TouchableOpacity onPress={onToggleStatus} style={[styles.checkButton, item.is_served ? styles.checkedButton : styles.uncheckedButton]}>
        <Icon name={item.is_served ? "checkmark-circle" : "ellipse-outline"} size={28} color={item.is_served ? "#10B981" : "#9CA3AF"} />
      </TouchableOpacity>
    </View>
  );
};
  ...
  return (
    <View style={styles.flex1}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<View style={{alignItems: 'center', marginTop: 50}}><Text style={{color: 'gray'}}>Chưa có món nào trong order này.</Text></View>}
      />
    </View>
  );
};
